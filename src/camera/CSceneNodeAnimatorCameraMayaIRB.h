...
namespace scene
{
	...
	*/
	class CSceneNodeAnimatorCameraMayaIRB : public ISceneNodeAnimatorCameraMaya
	{
	public:
		//! Constructor
		CSceneNodeAnimatorCameraMayaIRB(gui::ICursorControl* cursor, f32 rotateSpeed = -1500.f,
			f32 zoomSpeed = 200.f, f32 translationSpeed = 1500.f, f32 distance=70.f,
			SKeyMap2* keyMapArray=0, u32 keyMapSize=0);

		//! Destructor
		virtual ~CSceneNodeAnimatorCameraMayaIRB();
