...
#ifndef __C_GUI2_BUTTON_H_INCLUDED__
#define __C_GUI2_BUTTON_H_INCLUDED__
#include <irrlicht.h>
...
class CGUIButton2 : public irr::gui::IGUIButton
	{
	public:

		//! constructor
		CGUIButton2(irr::IrrlichtDevice* dev, IGUIEnvironment* environment, IGUIElement* parent,
...
#endif // __C_GUI_BUTTON2_H_INCLUDED__
